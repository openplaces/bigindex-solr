...
Add the power of the Solr search server to your Rails application with this easy to use gem. Meant to be used with Bigindex [http://github.com/openplaces/bigindex] in order to provide indexing functionality to your Rails application.
