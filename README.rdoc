...
Add the power of the Solr search server to your Rails application in this easy to use gem.

== Usage

(1) Add the following line RAILS_ROOT/config/environment.rb
...
Copyright (c) 2009 openplaces.org. See LICENSE for details.
